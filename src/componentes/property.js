                                    ...
                                    <div className="inner-wrapper">
                                        ...
                                        <div className="clear">
                                            <div className="col-xs-4 col-sm-4 dealer-face">
                                                <a href="index">
                                                    <img src="assets/img/client-face1.png" className="img-circle" alt="img" />
                                                </a>
                                            </div>
                                            <div className="col-xs-8 col-sm-8 ">
                                                <h3 className="dealer-name">
                                                    <a href="index">Nathan James</a><br/>
                                                    <span>Real Estate Agent</span>        
                                                </h3>
                                                <div className="dealer-social-media">
                                                    <a href="index" className="twitter" target="_blank">
                                                        <i className="fa fa-twitter"></i>
                                                    </a>
                                                    <a href="index" className="facebook" target="_blank">
                                                        <i className="fa fa-facebook"></i>
                                                    </a>
                                                    <a href="index" className="gplus" target="_blank">
                                                        <i className="fa fa-google-plus"></i>
                                                    </a>
                                                    <a href="index" className="linkedin" target="_blank">
                                                        <i className="fa fa-linkedin"></i>
                                                    </a> 
                                                    <a href="index" className="instagram" target="_blank">
